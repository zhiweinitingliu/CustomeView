...
import com.dukang.customeview.utils.LoadImage;
...
public class RecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerHolder setBigImage(int viewId, String url) {
        ImageView view = getView(viewId);
        LoadImage.loadRemoteGoodsImg(context, view, url);
        return this;
    }
    ...
    public RecyclerHolder setCircleImage2(int viewId, String url, int defResourceId) {
        ImageView view = getView(viewId);
        LoadImage.loadRemoteCircleImg2(context, view, url,defResourceId);
        return this;
    }
